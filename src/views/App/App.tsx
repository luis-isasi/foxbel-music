    ...
    <div>
      <header className="h-12 bg-red-200">
        <div className="max-w-2xl h-full mx-auto flex justify-between items-center px-3 xl:px-0">
          ...
          />
          <a
            href={`https://connect.deezer.com/oauth/auth.php?app_id=${process.env.NEXT_PUBLIC_APP_ID}&redirect_uri=${process.env.NEXT_PUBLIC_REDIRECT_URI}&perms=basic_access,email&response_type=token&offline_access`}
